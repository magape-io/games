...
(function() {
	...
	var d = document,
		...
		jiathis_utility_ifr = !! window.postMessage ? creElm({
			style: "display:none;",
			frameBorder: 0,
			src: JIATHIS_CONFIGS.codehost + "./statics/module/jiathis_utility.html"
		}, "iframe") : null,
		div = creElm({
		...
		clickpopjs, ckcpjs;
	creElm({
		href: JIATHIS_CONFIGS.codehost + "./statics/module/jiathis_share.css",
		rel: "stylesheet",
		type: "text/css"
	}, "link");
	$CKE = {
	...
	if (!conf.do_not_track && wlh && typeof(_gnayTrack) != 'object') {
		d.write('<script type="text/javascript" src="' + JIATHIS_CONFIGS.codehost + './statics/module/plugin.client.js" charset="utf-8"></script>')
	}
})();
